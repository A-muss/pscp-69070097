...
```
Step 1: reveive these 2 colors and turn them into list
Step 2: check that what primary color that is not in that list
Step 3: print out what two left colors mix
step 4: print error if the color in the list are not primary color
```
