...
```text
the problem wants to check that how much money will get from the bought lottery by comparing it to the lottery result
```
...
```text
receive 2 text that i want to compare, then print out he number that falls into that case
```
