...
```text
the problem want me to find the band of the number they gave by receiving the width of each band and the number of the last flower bed
```
...
```text
receive the number of band width and the last flower bed then add the total of the number on each diagonalline until it reach the last number then add them up and devided by the band width
```
