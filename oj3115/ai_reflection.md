...
| Item | Answer |
|---|---|
| OJ problem number/title | 3115 |
| OJ submission ID, if submitted | 580201	 |
| OJ status | Pass |
...
```text
i ask chat to explain the problem more clearly and help me visualise the way to do the problem
...
```text
i can use list to store the infomation than compare it later

and also make me know another way to do the problem by using the prefix sum, even tho i didn't using it, but atleast i know how it work and goint use it as a back up plan
```
...
```text
i still do everything by myself because i didn't do exact way chat told but changed to loop list input the data
```
...
```text
i learn how to use a prefix sum
```
