...
```
receive the price of the food and then print out the final price that include service fee and VAT. the service fee is 10% of the food, and the service fee will be at least 50 and max at 1000. VAT will be 7% of the food price that already includes the service fee.
```
